...
#Travis labeled code
for i in {1..22}; do plink2 --bgen MSM_TOPMED_Renamed_chr${i}.bgen ref-first --sample MSM_TOPMED_Renamed_chr${i}.sample --keep CAD_Samples_Travis_Ancestry_062725.txt --extract Norsid_hg38_intersects_BioMe_eMERGE_prs_adjustment.pc.sites --export vcf --out VCF_CAD_for_FlashPCA_Original/Norsid_CAD_Travis_Ancestry_chr${i}_062725; done

#Sinead Labeled Code
for i in {1..22}; do plink2 --bgen MSM_TOPMED_Renamed_chr${i}.bgen ref-first --sample MSM_TOPMED_Renamed_chr${i}.sample --keep CAD_Samples_Full_QC_Sinead_Race_Ethnicity_Labeled_062725.txt --extract Norsid_hg38_intersects_BioMe_eMERGE_prs_adjustment.pc.sites --export vcf --out VCF_CAD_for_FlashPCA_Original/Norsid_CAD_Sinead_Race_Ethnicity_chr${i}_062725; done

#Sinead Race and Ethnicity setting up for flashpca
for i in {1..22}; do plink2 --vcf VCF_CAD_for_FlashPCA_Original/Norsid_CAD_Sinead_Race_Ethnicity_chr${i}_062725.vcf --make-bed --out Binary_CAD_for_FlashPCA_Original/Norsid_CAD_Sinead_Race_Ethnicity_Binary_chr${i}_062925; done

plink --bfile Binary_CAD_for_FlashPCA_Original/Norsid_CAD_Sinead_Race_Ethnicity_Binary_chr1_062925 --merge-list CAD_Travis_Ancestry_mergelist_V1.txt --make-bed --out Autosome_Sinead_Race_Ethnicity_Binary_CAD_for_FlashPCA_Stage1_062925

flashpca --bfile Autosome_Sinead_Race_Ethnicity_Binary_CAD_for_FlashPCA_Stage1_062925 --project --inmeansd Norsid_hg38_intersects_BioMe_eMERGE_prs_adjustment.pc.meansd --outproj BioMe_Sinead_Race_Ethnicity_Projections_062925 --inload Norsid_hg38_intersects_BioMe_eMERGE_prs_adjustment.pc.loadings -v

#Travis ancestry setting up for flashpca
for i in {1..22}; do plink2 --vcf VCF_CAD_for_FlashPCA_Original/Norsid_CAD_Travis_Ancestry_chr${i}_062725.vcf --make-bed --out Binary_CAD_for_FlashPCA_Original/Norsid_CAD_Travis_Ancestry_Binary_chr${i}_062925; done

plink --bfile Binary_CAD_for_FlashPCA_Original/Norsid_CAD_Travis_Ancestry_Binary_chr1_062925 --merge-list CAD_Travis_Ancestry_mergelist_V1.txt --make-bed --out Autosome_Travis_Ancestry_Binary_CAD_for_FlashPCA_Stage1_062925

flashpca --bfile Autosome_Travis_Ancestry_Binary_CAD_for_FlashPCA_Stage1_062925 --project --inmeansd Norsid_hg38_intersects_BioMe_eMERGE_prs_adjustment.pc.meansd --outproj BioMe_Travis_Ancestry_Projections_062925 --inload Norsid_hg38_intersects_BioMe_eMERGE_prs_adjustment.pc.loadings -v
