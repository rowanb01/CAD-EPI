...
#Additional checks used in plotting
ggplot() + geom_point(data=PGC_Third_Travis_Catalog, aes(x=PC1,y=PC2, colour = Theta_mu1), size=3) + theme_classic() + theme(panel.border = element_rect(colour = "black",size=1,fill=NA)) + xlab("PC1") + ylab("PC2") + theme(legend.title = element_blank())
savePlot("Mu_Gradient_PC1_PC2_PGC_Third_Travis_Catalog_063025.png")
ggplot() + geom_point(data=PGC_Third_Travis_Catalog, aes(x=PC1,y=PC3, colour = Theta_mu1), size=3) + theme_classic() + theme(panel.border = element_rect(colour = "black",size=1,fill=NA)) + xlab("PC1") + ylab("PC3") + theme(legend.title = element_blank())
savePlot("Mu_Gradient_PC1_PC3_PGC_Third_Travis_Catalog_063025.png")
ggplot() + geom_point(data=PGC_Third_Travis_Catalog, aes(x=PC1,y=PC4, colour = Theta_mu1), size=3) + theme_classic() + theme(panel.border = element_rect(colour = "black",size=1,fill=NA)) + xlab("PC1") + ylab("PC4") + theme(legend.title = element_blank())
savePlot("Mu_Gradient_PC1_PC4_PGC_Third_Travis_Catalog_063025.png")
ggplot() + geom_point(data=PGC_Third_Travis_Catalog, aes(x=PC2,y=PC3, colour = Theta_mu1), size=3) + theme_classic() + theme(panel.border = element_rect(colour = "black",size=1,fill=NA)) + xlab("PC2") + ylab("PC3") + theme(legend.title = element_blank())
savePlot("Mu_Gradient_PC2_PC3_PGC_Third_Travis_Catalog_063025.png")
ggplot() + geom_point(data=PGC_Third_Travis_Catalog, aes(x=PC2,y=PC4, colour = Theta_mu1), size=3) + theme_classic() + theme(panel.border = element_rect(colour = "black",size=1,fill=NA)) + xlab("PC2") + ylab("PC4") + theme(legend.title = element_blank())
savePlot("Mu_Gradient_PC2_PC4_PGC_Third_Travis_Catalog_063025.png")
ggplot() + geom_point(data=PGC_Third_Travis_Catalog, aes(x=PC3,y=PC4, colour = Theta_mu1), size=3) + theme_classic() + theme(panel.border = element_rect(colour = "black",size=1,fill=NA)) + xlab("PC3") + ylab("PC4") + theme(legend.title = element_blank())
savePlot("Mu_Gradient_PC3_PC4_PGC_Third_Travis_Catalog_063025.png")
#Raw PRS density plots
ggplot(PGC_Third_Travis_Catalog, aes(x=PGS003446)) + geom_density()
savePlot("Combined_Travis_Ancestry_Raw_PRS_Density_Plot_063025.png")
ggplot(PGC_Third_Travis_Catalog, aes(x=PGS003446, color=Ancestry)) + geom_density()
savePlot("Ancestry_Specific_Raw_PRS_Density_Plot_063025.png")
q()
